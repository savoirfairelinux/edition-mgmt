...
{
    'name': 'Base Format Link Product Template',
    'version': '0.1',
    ...
    'license': 'AGPL-3',
    'category': 'Edition',
    'summary': 'This module associates formats and product templates.',
    'description': """
Base Format Link Product Template
=================================
This module permit to link a format with a product for each kind of printing.
