...
{
    'name': 'Publication Management Product Category',
    'version': '0.1',
    ...
    'description': """
Publication Management Product Category
=======================================
This module creates a relation of 1 for 1 with publication.management and
product.category.
The version (product.template) acquires the publication.management's
product.category at the creation.
