...
class test_product_template(common.TransactionCase):
    ...
    def test_categ_id_is_publication_categ(self):
        """The internal category of a version is the same as the publication
        category.
        """
        ...
        self.assertEqual(
            template.categ_id, self.publication.product_category_id
        )
